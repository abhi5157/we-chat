...
function UpdateNotification({ onDismiss }) {
  return (
    <div className="fixed top-4 right-4 bg-white shadow-lg rounded-lg p-4 max-w-sm" style={{'width':"20%"}}
        >
      <div className="flex items-start">
        ...
        <div className="ml-3 w-0 flex-1 pt-0.5">
          <p className="text-sm font-medium text-gray-900">We've just released a new update!</p>
